...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editEmail=(EditText)findViewById(R.id.yourEmail);
        editUsername=(EditText)findViewById(R.id.yourUsername);
        editPassword=(EditText)findViewById(R.id.yourPassword);
